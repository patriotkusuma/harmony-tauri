    ...
    >
      ...
      <CardHeader className="bg-transparent py-2 px-3">
        <Row className="align-items-center">
          ...
          <Col xs="6" className="text-end">
            <StatusBadge status={pesan.status} className="me-1 py-1" style={{ fontSize: '0.65rem' }} />
      ...
      <CardBody className="py-2 px-3">
        <div className="d-flex align-items-center mb-2">
          <div
            className="me-2 rounded-circle overflow-hidden shadow-sm d-flex align-items-center justify-content-center bg-white"
        ...
        <div className="mb-3">
          {Array.isArray(pesan.detail_pesanans) && pesan.detail_pesanans.slice(0, 2).map((d, i) => (
            <div key={i} className="text-sm">
              <i className="fas fa-check-circle me-1 text-success-light opacity-5" />
        ...
        {!isBatalOrDiambil && (
          <div className="d-flex flex-wrap align-items-center mb-1" style={{ gap: '6px' }}>
            ...
            <div className="ms-auto d-flex" style={{ gap: '8px' }}>
               {pesan.status === "cuci" && (
                 <a
                   href="#"
