        ...
        <Row>
          <Col md="6">
            <div className="d-flex align-items-center mb-4">
              <div
                className="mr-3 rounded-circle overflow-hidden shadow-sm d-flex align-items-center justify-content-center bg-white"
      ...
      <ModalFooter className="border-0 bg-transparent justify-content-between">
        <div className="d-flex" style={{ gap: "8px" }}>
          <Button color="success" size="sm" onClick={() => printName(selectedOrder)}>
            <i className="fas fa-print mr-1" /> Nama
          </Button>
        ...
        <div>
          ...
          >
            <i className="fas fa-edit mr-1" /> Edit Detail
          </Button>
