  ...
  return (
    ...
    >
        ...
        >
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <button
              ...
              className="floating-rfid-btn-close"
            >
      ...
      <style>{`
        ...
        .floating-rfid-btn-close { background: transparent; border: none; color: #aaa; cursor: pointer; font-size: 16px; }
        .floating-rfid-btn-close:hover { color: #333; }
        ...
        .dark-mode .floating-rfid-btn-close { color: #6060a0; }
        .dark-mode .floating-rfid-btn-close:hover { color: #fff; }
