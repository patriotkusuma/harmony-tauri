          ...
          <div className="header-body">
            <Row className="align-items-center py-4">
              <Col lg="6" xs="7">
                ...
                <nav aria-label="breadcrumb" className="d-none d-md-inline-block ms-md-4">
                   <div className="text-white opacity-8 h1 mb-0 border-left ps-4" style={{ fontWeight: 300 }}>
                      {moment().format("HH:mm")}
                   </div>
                </nav>
              </Col>
              <Col lg="6" xs="5" className="text-end">
                <Button 
                  color="neutral" 
                  size="sm" 
                ...
                >
                  <i className={`fas fa-sync-alt me-2 ${isLoading ? 'fa-spin' : ''}`} />
                  Refresh Data
                </Button>
              </Col>
            </Row>
