                ...
                <Row className="align-items-center">
                    ...
                    <Col md="6" className="mt-3 mt-md-0">
                        <div className="d-flex align-items-center">
                            <div className="input-group input-group-alternative input-group-merge shadow-sm flex-grow-1 mr-3 rounded-pill overflow-hidden border">
                            ...
                            <div className="d-none d-lg-flex">
                                <Button color="info" size="sm" className="btn-icon shadow-sm rounded-circle p-2 mr-2" onClick={onPrintLastOrder} title="F3: Cetak Struk Terakhir">
                                    <i className="fas fa-print" />
                                </Button>
                                <Button color="warning" size="sm" className="btn-icon shadow-sm rounded-circle p-2 mr-2" onClick={onRFIDAttach} title="F4: Sangkut RFID Terakhir">
