        ...
        <Modal isOpen={isOpen} toggle={() => !loading && toggle()} size="lg" centered contentClassName="border-0 shadow-lg" style={{ borderRadius: '20px' }}>
            <ModalHeader toggle={() => !loading && toggle()} className="bg-gradient-info text-white py-4 border-0">
                <div className="d-flex align-items-center">
                    <i className={`fas ${editMode ? 'fa-edit' : 'fa-shopping-cart'} fa-2x me-3 text-white-50`} />
                    <div>
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <Row>
                        ...
                        <Col md="12">
                            ...
                            <Row>
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Supplier / Vendor</Label>
                                        <Input
                                            required
                                            type="select"
                                ...
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Tanggal Pembelian</Label>
                                        <Input
                                            required
                                            type="date"
                            ...
                            <FormGroup>
                                <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Nama Barang / Jasa</Label>
                            ...
                            <Row>
                                <Col md="4">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Qty (Jumlah)</Label>
                                        <Input
                                            required
                                            type="number"
                                            value={form.quantity}
                                ...
                                <Col md="4">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Satuan</Label>
                                        <Input
                                            required
                                            type="select"
                                            value={form.id_unit}
                                ...
                                <Col md="4">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Total Amount (Rp)</Label>
                                        <Input
                                            required
                                            type="text"
                        ...
                        <Col md="12" className="mt-3">
                            ...
                            <Row>
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Tipe Pembelian</Label>
                                        <Input
                                            required
                                            type="select"
                                            value={form.type}
                                        ...
                                        {form.type === 'Persediaan' && (
                                            <Alert color="info" className="py-1 px-2 mt-2 border-0 small font-weight-bold opacity-8">
                                                <i className="fas fa-info-circle me-1" /> Item ini akan menambah stok Inventory secara otomatis.
                                            </Alert>
                                        )}
                                    </FormGroup>
                                </Col>
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Catatan Tambahan</Label>
                                        <Input
                                            type="textarea"
                                            rows="2"
                                            placeholder="..."
                            ...
                            <Row>
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Sumber Dana (Kredit)</Label>
                                        <Input
                                            required
                                            type="select"
                                ...
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1 text-uppercase">Pos Pengeluaran (Debit)</Label>
                                        <Input
                                            required
                                            type="select"
                ...
                <ModalFooter className="bg-white border-0 p-4">
                    ...
                    <Button color="info" type="submit" disabled={loading} className="px-5 shadow-premium font-weight-bold rounded-pill py-2">
                        {loading ? (
                            <><i className="fas fa-spinner fa-spin me-2" />Memproses...</>
                        ) : (
                            <><i className={`fas ${editMode ? 'fa-save' : 'fa-check-circle'} me-2`} />{editMode ? "Simpan Perubahan" : "Konfirmasi Pembelian"}</>
                        )}
                    </Button>
                </ModalFooter>
            </form>
