                ...
                <Row className="align-items-center">
                    <Col md="7">
                        ...
                        <div className="d-flex align-items-center">
                            <span className="h2 font-weight-900 mb-0 text-danger mr-2">
                                <RupiahFormater value={totalUnpaid} />
                            </span>
                            <Badge color="danger" pill className="px-2 py-1 font-weight-bold shadow-sm">
                                <i className="fas fa-exclamation-circle mr-1" /> Belum Bayar
                            </Badge>
                        </div>
                    </Col>
                        ...
                        {customers.map((customer) => {
                            ...
                            return (
                                <Col lg={viewMode === 'modern' ? "4" : "12"} md={viewMode === 'modern' ? "6" : "12"} key={customer.id} className="mb-3">
                                    ...
                                    >
                                        <div className={`avatar avatar-md rounded-circle shadow-inner mr-3 d-flex align-items-center justify-content-center bg-primary text-white`} style={{ minWidth: '45px', height: '45px', overflow: 'hidden' }}>
