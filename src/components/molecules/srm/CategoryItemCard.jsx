      ...
      <CardBody className="py-2 px-3">
        <div className="d-flex align-items-center justify-content-between">
          <div className="d-flex align-items-center overflow-hidden me-2">
             <div className={`icon-box me-3 d-flex align-items-center justify-content-center rounded-lg ${isActive ? 'bg-primary text-white' : 'bg-light text-muted'}`} style={{ width: 36, height: 36, minWidth: 36 }}>
             ...
             <div className="overflow-hidden">
                ...
                <div className="d-flex align-items-center mt-1">
                   <Badge color={isActive ? "primary" : "secondary"} className="me-2" style={{ fontSize: '0.6rem', padding: '2px 6px' }}>
          ...
          <UncontrolledDropdown>
            ...
            <DropdownMenu className="dropdown-menu-arrow" end style={{ borderRadius: '12px', zIndex: 1050 }}>
              <DropdownItem onClick={(e) => { e.stopPropagation(); onEdit(category); }} className="py-2">
                <i className="fas fa-edit text-primary me-2" /> <span className="small">Edit Kategori</span>
              </DropdownItem>
              <DropdownItem divider />
              <DropdownItem onClick={(e) => { e.stopPropagation(); onDelete(category.id); }} className="py-2">
                <i className="fas fa-trash text-danger me-2" /> <span className="small">Hapus Permanen</span>
              </DropdownItem>
            </DropdownMenu>
          </UncontrolledDropdown>
