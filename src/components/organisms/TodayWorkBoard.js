        ...
        {(!urutanKerja || urutanKerja.length === 0) ? (
          ...
          urutanKerja.map((urutan, index) => {
            ...
            return (
              ...
              >
                <div className="mr-3 text-center" style={{ width: '40px' }}>
                  <span className={`badge badge-pill ${isTop ? 'badge-danger pulse-animation' : 'badge-dark'}`} style={{ fontSize: '0.8rem' }}>
                    #{index + 1}
                  </span>
                  {isTop && (
                ...
                <div className="flex-grow-1 min-w-0 pr-2">
