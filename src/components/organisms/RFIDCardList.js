                ...
                <Row className="align-items-center">
                    <Col>
                        <h3 className="mb-0 text-dark font-weight-bold">
                            <i className="fas fa-list-ul mr-2 text-primary" />
                            Daftar Kartu RFID
                        </h3>
                    </Col>
                    <Col className="text-right d-flex justify-content-end" style={{ gap: '8px' }}>
                ...
                <Row className="gy-3">
                    ...
                    <Col md="7">
                        <div className="d-flex flex-wrap align-items-center justify-content-md-end" style={{ gap: '8px' }}>
                            <span className="text-xs font-weight-bold text-muted mr-1">TIPE:</span>
                            ...
                            <span className="text-xs font-weight-bold text-muted mr-1">STATUS:</span>
                        ...
                        <Table className="align-items-center table-flush border-0" hover>
                            <thead className="thead-light">
                                <tr className="bg-secondary-soft">
                                    ...
                                    <th className="font-weight-bold text-dark border-0 py-4 text-right">Tindakan</th>
                                </tr>
                            </thead>
                            <tbody>
                                {rfids.map((card, idx) => {
                                        ...
                                        <tr key={card.id} className="transition-all">
                                            ...
                                            <td className="py-4 border-0">
                                                <div className="d-flex align-items-center">
                                                    <div className={`mr-3 rounded-lg shadow-sm d-flex align-items-center justify-content-center bg-white border border-${type.color}`} style={{ width: '40px', height: '40px' }}>
                                            ...
                                            <td className="py-4 border-0">
                                                <Badge color={status.color} className="shadow-none rounded-pill px-3 py-1 font-weight-bold">
                                                    {card.status === "ASSIGNED" && <i className="fas fa-lock mr-2" />}
                                                    {status.label}
                                                </Badge>
                                            </td>
                                            <td className="py-4 border-0">
                                                {card.user_id ? (
                                                    <span className="text-dark font-weight-bold">
                                                        <i className="fas fa-user-circle mr-2 opacity-5" />
                                                        {card.user_id}
                                                    </span>
                                                ) : (
