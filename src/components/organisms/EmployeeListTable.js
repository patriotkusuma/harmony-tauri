                                    ...
                                    <tr key={emp.id} className="transition-all">
                                        <td className="py-4 border-0">
                                            <div className="d-flex align-items-center">
                                                <div className="avatar rounded-circle mr-3 bg-primary text-white shadow-sm d-flex align-items-center justify-content-center" style={{ width: '40px', height: '40px' }}>
                                        ...
                                        <td className="py-4 border-0">
                                            <div className="text-sm">
                                                <div className="mb-1 text-dark font-weight-bold">
                                                    <i className="fas fa-phone mr-2 text-primary opacity-5" /> {emp.telpon || "-"}
                                                </div>
                                                <div className="text-success font-weight-bold">
                                                    <i className="fab fa-whatsapp mr-2 opacity-7" /> {emp.no_wa || "-"}
                                                </div>
                                            </div>
                                        </td>
                                        <td className="py-4 border-0">
                                            ...
                                            {emp.rfid_code && (
                                                <div className="mt-2">
                                                    <Badge color="default" outline className="border shadow-none font-weight-900 text-dark px-2">
                                                        <i className="fas fa-id-card mr-1 text-primary" /> {emp.rfid_code}
                                                    </Badge>
                                                </div>
                                            )}
                                        </td>
