        ...
        <Modal isOpen={isOpen} toggle={() => !loading && toggle()} size="lg" centered contentClassName="border-0 shadow-lg" style={{ borderRadius: '15px' }}>
            <ModalHeader toggle={() => !loading && toggle()} className="bg-gradient-primary text-white py-4 border-0">
                <div className="d-flex align-items-center">
                    <i className={`fas ${editMode ? 'fa-user-edit' : 'fa-user-plus'} fa-2x me-3 text-white-50`} />
                    <div>
                ...
                <ModalBody className="py-4">
                    <Row>
                        ...
                        <Col md="6">
                            ...
                            <FormGroup>
                                <Label className="text-xs font-weight-bold text-muted ms-1">NAMA LENGKAP</Label>
                                <Input
                                    required
                            ...
                            <FormGroup>
                                <Label className="text-xs font-weight-bold text-muted ms-1">EMAIL LOGIN</Label>
                                <Input
                                    required
                                    type="email"
                            ...
                            <FormGroup>
                                <Label className="text-xs font-weight-bold text-muted ms-1">
                            ...
                            <Row>
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1">PERAN (ROLE)</Label>
                                        <Input
                                            type="select"
                                            value={form.role}
                                ...
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1">GAJI (RP)</Label>
                                        <Input
                                            type="number"
                                            value={form.gaji}
                        ...
                        <Col md="6">
                            ...
                            <Row>
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1">TELEPON</Label>
                                        <Input
                                            placeholder="081xxx"
                                            value={form.telpon}
                                ...
                                <Col md="6">
                                    <FormGroup>
                                        <Label className="text-xs font-weight-bold text-muted ms-1">WHATSAPP</Label>
                                        <Input
                                            placeholder="6281xxx"
                                            value={form.no_wa}
                            ...
                            <FormGroup>
                                <Label className="text-xs font-weight-bold text-muted ms-1">TANGGAL MASUK</Label>
                                <Input
                                    type="date"
                            ...
                            <FormGroup>
                                <Label className="text-xs font-weight-bold text-muted d-block ms-1">STATUS AKTIVASI</Label>
                            ...
                            <FormGroup className="mb-0">
                                <Label className="text-xs font-weight-bold text-muted ms-1">HAK AKSES OUTLET</Label>
                        ...
                        <Col md="12" className="mt-3">
                            <FormGroup className="mb-0">
                                <Label className="text-xs font-weight-bold text-muted ms-1">ALAMAT LENGKAP</Label>
                                <Input
                                    type="textarea"
                                    rows="2"
                ...
                <ModalFooter className="bg-light border-0 p-4">
                    ...
                    <Button color="primary" type="submit" disabled={loading} className="px-5 shadow-premium font-weight-bold rounded-lg py-2">
                        {loading ? (
                            ...
                            <><i className={`fas ${editMode ? 'fa-save' : 'fa-check-circle'} me-2`} />{editMode ? "Perbarui Data" : "Simpan Pegawai"}</>
                        )}
                    </Button>
                </ModalFooter>
            </form>
