  ...
  return (
    <Card className="border-0 shadow-lg detail-panel overflow-hidden">
      <CardHeader className="bg-transparent border-0 pt-4 pb-0 d-flex align-items-center">
        <Button color="link" onClick={onBack} className="p-0 mr-3 text-dark">
          ...
          <Row>
            <Col lg="4" className="text-center mb-4">
               ...
               {imageFile && (
                 ...
                 >
                   {isUploading ? <Spinner size="sm" /> : <><i className="fas fa-upload mr-2" /> Unggah Sekarang</>}
                 </Button>
               )}

               <div className="mt-4 p-3 rounded-lg bg-light text-left border">
               ...
               <div className="mt-3 p-3 rounded-lg bg-light text-left border">
