                  ...
                  <>
                    <Alert color={deviceInfo.is_connected ? "success" : "danger"} className="border-0 shadow-sm mb-4">
                      <div className="d-flex align-items-center">
                        <i className={`fas ${deviceInfo.is_connected ? "fa-check-circle" : "fa-exclamation-triangle"} fa-2x mr-3`} />
                        <div>
                    ...
                    <div className="mb-5 bg-white p-4 rounded-lg shadow-sm border">
                      <h4 className="mb-4 text-primary">
                        <i className="fas fa-image mr-2" /> Update WhatsApp Profile Picture
                      </h4>
                      <Row className="align-items-center">
                        ...
                        <Col md="12" className="mt-3">
                          ...
                          >
                            {uploading ? <Spinner size="sm" className="mr-2" /> : <i className="fas fa-upload mr-2" />}
                            Update Foto Profil
                          </Button>
                        </Col>
                      </Row>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm border">
                      <h4 className="mb-4 text-primary">
                        <i className="fas fa-user-edit mr-2" /> Update Display Name
                      </h4>
                      <FormGroup>
                      ...
                      <Button 
                        ...
                        disabled={savingName}
                      >
                        {savingName ? <Spinner size="sm" className="mr-2" /> : <i className="fas fa-save mr-2" />}
