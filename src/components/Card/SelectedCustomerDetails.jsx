      ...
      <Card className="mb-3 shadow-sm">
        ...
        <CardBody className="py-2">
          <Row>
            ...
            <Col xs="7" className="text-end text-dark text-truncate" title={customer.nama}>{customer.nama}</Col>
          </Row>
          <Row>
            <Col xs="5"><strong>No. WA</strong></Col>
            <Col xs="7" className="text-end text-dark text-truncate" title={customer.telpon}>{customer.telpon}</Col>
          </Row>
          {customer.totalBayar > 0 && (
            <Row className="mt-1 pt-1 border-top">
              <Col xs="5"><strong>Total Tagihan</strong></Col>
              <Col xs="7" className="text-end text-dark font-weight-bold"><RupiahFormater value={customer.totalBayar} /></Col>
            </Row>
          )}
        </CardBody>
      </Card>
