      ...
      {logs.map((log, index) => {
        ...
        return (
          <div key={index} className="order-log-item d-flex position-relative">
            {/* LEFT AXIS */}
            <div className="order-log-left me-3 d-flex flex-column align-items-center">
              <div
              ...
              <div className="bg-light-soft p-2 rounded-lg border-0 mt-2">
                <div className="d-flex justify-content-between align-items-center mb-1">
                    <small className="text-dark font-weight-700">
                        <i className="fas fa-microchip me-1 opacity-5" />
                        Mesin {log.machine_id}
                    </small>
                    {log.operator_id && (
                        <small className="text-muted">
                            <i className="far fa-user me-1 opacity-5" />
                            {log.operator_id}
                        </small>
                    )}
                </div>
