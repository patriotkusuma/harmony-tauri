...
import { Modal, ModalHeader, ModalBody, ModalFooter, Button, FormGroup, Label, Input, InputGroup, InputGroupAddon, InputGroupText, Spinner } from 'reactstrap';
                    ...
                    <div className="quick-amounts d-flex flex-wrap mt-2">
                        {[50000, 100000, 200000, 500000].map(amt => (
                            <Button 
                                ...
                                size="sm" 
                                color="outline-info" 
                                className="mr-2 mb-2 rounded-pill px-3"
