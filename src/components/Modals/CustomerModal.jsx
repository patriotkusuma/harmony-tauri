                            ...
                            <Col md="6">
                                <FormGroup>
                                    ...
                                    <div className="d-flex align-items-center">
                                            ...
                                            <Dropdown isOpen={isDropdownOpen} toggle={() => setIsDropdownOpen(!isDropdownOpen)}>
                                                ...
                                                >
                                                    ...
                                                    {COUNTRY_LIST.filter(c => 
                                                        ...
                                                        >
                                                            <span className="me-2" style={{ fontSize: '1.2rem' }}>{country.flag}</span>
                                        ...
                                        />
                                        <div className="ms-2" style={{ width: '25px' }}>
                                            {isCheckingWA ? (
                                    ...
                                    {waStatus === 'active' && <small className="text-success font-weight-bold ms-1">Terdaftar di WhatsApp</small>}
                                    {waStatus === 'inactive' && <small className="text-danger font-weight-bold ms-1">Tidak terdaftar di WhatsApp</small>}
                                </FormGroup>
                            </Col>
                        </Row>
                                ...
                                <div className="mt-2">
                                    ...
                                    {pelanggan.map((plg) => (
                                        <Col md="6" xs="12" key={plg.id} className="px-1">
                                            <Button
                                                className="w-100 mb-2 text-start p-2 shadow-sm"
                                            ...
                                            >
                                                ...
                                                <div style={{ flex: 1, minWidth: 0 }}>
                                                    ...
                                                    <div className={`text-truncate text-sm ${hoveredCustomerId === plg.id ? "text-light" : "text-muted"}`}>
                                                        <i className="fab fa-whatsapp me-1"></i>{plg.telpon}
                                                    </div>
