        ...
        return (
          <div className="text-center">
            ...
            <h4 className="text-white px-2 py-1 bg-default rounded-pill mb-0 mt-2 text-sm">
              <span className="me-1">{param.status}</span>
        ...
        return (
          <div className="text-center">
            ...
            <h4 className="text-white px-2 py-1 bg-success rounded-pill mb-2 mt-2 text-sm">
              <span className="me-2">{param.status}</span>
            </h4>
          ...
          return (
            ...
            <td className="position-relative" style={{ minWidth: "180px" }}>
              ...
              <div className="d-flex flex-column h-100">
                ...
                >
                  {pesan.kode_pesan}
                  <i className="fas fa-copy ms-2 text-muted" />
                </span>
            ...
            <td className="d-flex flex-column justify-content-center">
              <div className="d-flex align-items-center mb-2">
                <div
                  className="me-2 rounded-circle overflow-hidden shadow-sm d-flex align-items-center justify-content-center bg-primary text-white font-weight-bold"
              ...
              <div className="d-flex flex-wrap mt-1" style={{ gap: "6px" }}>
                <span
                  ...
                  className="badge bg-success text-white rounded-pill shadow-sm cursor-pointer"
                >
                ...
                <span
                  className={`badge bg-${pesan.notify_pesan_error === 1 && pesan.notify_pesan === 0 ? "warning" : "info"} text-white rounded-pill shadow-sm`}
                >
                  <i className="fas fa-paper-plane me-1"></i> Inv{" "}
                  {pesan.notify_pesan_error === 1 && pesan.notify_pesan === 0 ? "Gagal" : "OK"}
                </span>

                {pesan.status === "selesai" && (
                  <span
                    className={`badge bg-${pesan.notify_selesai === 0 ? "danger" : "default"} text-white rounded-pill shadow-sm`}
                  >
                    <i className="fas fa-bell me-1"></i> Notif{" "}
              ...
              {pesan.status !== "batal" && (
                <div className="mt-2">
                  ...
                  >
                    <i className="fa-solid fa-print me-1 text-primary"></i>
                    Print Nama
                  </Button>
                </div>
              )}
            ...
            <td className="align-middle text-center">
              <div
                className={`badge bg-${pesan.status_pembayaran === "Lunas" ? "success" : "danger"} text-white rounded-pill px-3 py-2 mb-2 shadow-sm`}
                style={{ fontSize: "0.8rem" }}
              >
                <i
                  className={`fas fa-${pesan.status_pembayaran === "Lunas" ? "check" : "exclamation-triangle"} me-1`}
                />
