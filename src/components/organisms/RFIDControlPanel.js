...
import { Card, CardHeader, CardBody, Badge, Button, CustomInput, FormGroup } from 'reactstrap';
            ...
            <CardBody className="text-center py-5">
                ...
                {scannedRFID ? (
                    <div className="mb-4">
                        ...
                        <div className="text-muted text-xs mt-2 italic">
                            <i className="far fa-clock mr-1" /> Scan terakhir: {moment(lastScan?.receivedAt).format("HH:mm:ss")}
                        </div>
                        <Button color="link" size="sm" className="text-danger mt-1" onClick={clearUID}>
                            <i className="fas fa-undo mr-1" /> Reset Scan
                        </Button>
                    </div>
                ) : (
                ...
                {activeMode === "attach" ? (
                    <div className="text-left px-2">
                        ...
                        >
                            <i className="fas fa-link mr-2" /> Hubungkan RFID
                        </Button>
                    </div>
                ) : (
                    <div className="mt-2 px-2 text-center">
                        ...
                        <Button
                            ...
                            className="shadow-premium py-2 font-weight-bold"
                        >
                            <i className="fas fa-unlink mr-2" /> Putuskan Koneksi
                        </Button>
                    </div>
                )}
            </CardBody>
