           ...
           <Card className="mb-2">
                <CardHeader className="pb-2">
                    <Row className="d-flex align-items-center justify-content-between">
                        ...
                        <Col className="text-right" xs="7" style={{ display: 'flex', gap: 4, justifyContent: 'flex-end', flexWrap: 'nowrap' }}>
                            ...
                            <Button color="primary" size="sm" onClick={onEditCustomer} className="ml-1" title="Edit Pelanggan (F2)">
