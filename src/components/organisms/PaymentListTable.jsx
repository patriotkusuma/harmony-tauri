...
const PaymentListTable = ({ 
    ...
    const checkTipe = (tipe) => {
        switch (tipe) {
            case "qris":
                return <Badge color="success" className="px-3 py-2 rounded-pill shadow-none border"><i className="fas fa-qrcode me-2" />QRIS</Badge>;
            case "cash":
                return <Badge color="warning" className="px-3 py-2 rounded-pill shadow-none border text-white"><i className="fas fa-wallet me-2" />CASH</Badge>;
            case "tf":
                return <Badge color="primary" className="px-3 py-2 rounded-pill shadow-none border"><i className="fas fa-exchange-alt me-2" />TRANSFER</Badge>;
            default:
                                    ...
                                    >
                                        ...
                                        <td className="py-4 border-0">
                                            <div className="d-flex align-items-center">
                                                <div className="me-3 rounded-circle bg-primary-soft-10 d-flex align-items-center justify-content-center shadow-inner" style={{ width: '40px', height: '40px' }}>
                                        ...
                                        <td className="py-4 border-0 text-dark font-weight-bold text-sm">
                                            <i className="far fa-calendar-alt me-2 opacity-5" />
