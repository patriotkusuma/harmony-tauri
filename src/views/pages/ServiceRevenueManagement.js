    ...
    <div className="srm-page">
      ...
      <Container className="mt--7 mb-5" fluid>
        {isLoading && categories.length === 0 ? (
          ...
          <Row>
            {viewMode === "category" && (
              <Col lg="3" className="mb-4 pr-lg-2 animate__animated animate__fadeInLeft">
            ...
            <Col lg={viewMode === "category" ? "9" : "12"} className="mb-4 pl-lg-2 animate__animated animate__fadeIn">
