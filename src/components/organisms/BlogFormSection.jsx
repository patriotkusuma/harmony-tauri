                    ...
                    <Row>
                        ...
                        <Col lg="8">
                            <FormGroup className="mb-4">
                                <Label className="text-muted text-xs font-weight-bold ms-1">JUDUL ARTIKEL</Label>
                                <Input
                                    type="text"
                                    name="title"
                            ...
                            <FormGroup>
                                <Label className="text-muted text-xs font-weight-bold ms-1">KONTEN ARTIKEL</Label>
