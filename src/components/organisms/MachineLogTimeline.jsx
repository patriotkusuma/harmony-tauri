...
const MachineLogTimeline = ({ logs, loading }) => {
    ...
    return (
        <CardBody className="px-3 px-md-5 py-5 bg-soft-light transition-all">
            <div className="timeline-wrapper ps-lg-4">
                {logs.map((log, index) => {
                    ...
                    return (
                        <div key={index} className="timeline-entry d-flex position-relative mb-5">
                            {/* VERTICAL AXIS */}
                            <div className="timeline-axis me-3 me-md-4 d-flex flex-column align-items-center">
                                <div 
                            ...
                            <div className="timeline-body w-100 flex-grow-1">
                                <div className="d-flex justify-content-between align-items-center mb-3">
                                    <div className="d-flex align-items-center flex-wrap gap-2">
                                        ...
                                        >
                                            {isRunning && <i className="fas fa-play-circle me-2 animate-flicker" />}
                                            {meta.label}
                                        </Badge>
                                        <span className="text-muted font-weight-600 ms-2">
                                            <i className="fas fa-server me-1 opacity-5" />
                                            {log.machine_id}
                                        </span>
                                    </div>
                                    <div className="log-timing text-end">
                                        ...
                                        {durationText && (
                                            <small className="text-info font-weight-bold">
                                                <i className="far fa-hourglass me-1" />
                                                {durationText}
                                            </small>
                                        )}
                                        {isRunning && (
                                ...
                                <div className="log-card p-4 rounded-xl shadow-premium border-0 bg-white glass-effect hover-lift transition-all">
                                    <Row className="align-items-center">
                                        <Col md="7">
                                            <div className="d-flex align-items-center mb-3">
                                                <div className="avatar-placeholder rounded-circle bg-soft-info me-3 d-flex align-items-center justify-content-center" style={{ width: '40px', height: '40px' }}>
                                            ...
                                            <div className="d-flex align-items-center">
                                                <div className="badge badge-soft-dark py-1 px-3 rounded-pill border">
                                                    <i className="fas fa-hashtag me-2 opacity-5" />
                                                    {log.kode_pesan}
                                                </div>
                                            </div>
                                        </Col>
                                        <Col md="5" className="mt-3 mt-md-0 text-md-end border-md-left">
                                            <div className="mb-2">
                                            ...
                                            {log.operator_id && (
                                                <div>
                                                    ...
                                                    <span className="text-sm font-weight-700 text-dark">
                                                        <i className="far fa-id-badge me-2 opacity-4" />
                                                        {log.operator_id}
                                                    </span>
                                                </div>
                                            )}
                                    ...
                                    {log.keterangan && (
                                        <div className="mt-4 pt-3 border-top position-relative">
                                            ...
                                            <p className="text-sm text-dark font-italic mb-0 ps-4">{log.keterangan}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
