  ...
  return (
    <>
      ...
      <style>{`
        ...
        .custom-switch-notification .custom-control-label {
          width: 100%;
          cursor: pointer;
          font-weight: 500;
          color: #525f7f;
        ...
        .custom-switch-notification .custom-control-label::before,
        .custom-switch-notification .custom-control-label::after {
          top: 50% !important;
        ...
        .custom-switch-notification .custom-control-input:checked ~ .custom-control-label::after {
        ...
        .dark-mode .custom-switch-notification .custom-control-label::before {
          background-color: #2b2b4b !important;
          border-color: #32325d !important;
        }
        .dark-mode .custom-switch-notification .custom-control-label {
          color: #ced4da !important;
        }
