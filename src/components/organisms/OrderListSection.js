    ...
    return (
        <Card className="shadow-premium border-0 glass-card">
                ...
                <Row className="align-items-center">
                    <Col xs="8">
                        <h3 className="mb-0 text-dark font-weight-bold">
                            <i className="fas fa-id-badge mr-2 text-primary" />
                            Daftar Pesanan
                        </h3>
                    </Col>
            ...
            <CardBody className="pt-0">
                ...
                <div className="pr-2" style={{ maxHeight: '500px', overflowY: 'auto' }}>
                    {loading ? (
                                        ...
                                        <div className="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div className="d-flex align-items-center mb-1">
                                                    <span className="font-weight-bold text-primary mr-2 h5 mb-0">{order.kode_pesan}</span>
                                                ...
                                                <small className="text-muted"><i className="far fa-clock mr-1" />{moment(order.created_at).format("DD MMM, HH:mm")}</small>
                                            </div>
                                        ...
                                        <div className="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <Badge color={isHighlighted ? "warning" : "success"} pill className="px-3">
                                                    <i className="fas fa-tag mr-2" />{order.rfid_code}
                                                </Badge>
                                            </div>
