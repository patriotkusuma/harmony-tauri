import asset_0_zt2xia from "../../assets/img/theme/team-1-800x800.jpg";
...
const MySidebar = (props) => {
  ...
  return (
    <Navbar
      className="navbar-vertical fixed-start navbar-light bg-white"
      expand="md"
      id="sidenav-main"
    >
      <Container fluid>
        ...
        <Nav className="align-items-center d-md-none">
          ...
          <UncontrolledDropdown nav>
            ...
            <DropdownMenu className="dropdown-menu-aroow" end>
