...
import Team1Logo from "assets/img/theme/team-1-800x800.jpg";
...
const Sidebar = (props) => {
  ...
  return (
    <Navbar
      className={`navbar-vertical fixed-start navbar-light bg-white ${isCollapsed ? 'navbar-collapsed' : ''}`}
      expand="md"
      id="sidenav-main"
    >
      <Container fluid>
        ...
        {logo ? (
          <NavbarBrand className="pt-0" {...navbarBrandProps}>
            <img
              ...
              src={isCollapsed ? "/logoku.svg" : logo.imgSrc}
            />
            {!isCollapsed && (
        ...
        <Collapse navbar isOpen={collapseOpen}>
          ...
          <div className="navbar-collapse-header d-md-none">
            <Row>
              ...
              <Col className="collapse-btn-close" xs="6">
                <button
                  className="navbar-toggler"
                  type="button"
                  onClick={toggleCollapse}
            ...
            {user !== null && (user.role === "admin" || user.role === "owner") && (
              <NavItem>
                <NavLink to="/admin/service-revenue" tag={NavLinkRRD} onClick={closeCollapse}>
                  ...
                  <span className="ms-2">Service & Revenue</span>
                </NavLink>
              </NavItem>
            )}
            <NavItem>
